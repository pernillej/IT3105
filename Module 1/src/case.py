...
class Case:
    ...
    def generate_cases(self):
        if self.data_source == "mnist":  # TODO
            ...
            return self.read_from_file("./data/winequality_red.txt", seperator=";", num_classes=6)
        elif self.data_source == "glass":
            return self.read_from_file("./data/glass.txt", seperator=",", num_classes=6)
        elif self.data_source == "yeast":
            return self.read_from_file("./data/yeast.txt", seperator=",", num_classes=10)
        elif self.data_source == "hackers-choice":  # Hackers-choice: Iris data set
            return self.read_from_file("./data/iris.txt", seperator=",", num_classes=3)
    ...
    def read_from_file(self, filename, seperator, num_classes, normalize=True):  # TODO
