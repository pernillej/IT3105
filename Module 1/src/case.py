...
class Case:
    ...
    def __init__(self, data_source, validation_fraction, test_fraction, case_fraction=1.0):
        ...
        # Generate and organize cases
        self.generate_cases()
        self.organize_cases()

    def generate_cases(self):
        """ Generate cases from datasource or function"""
        ...
        elif self.data_source == "hackers-choice":  # Hackers-choice: White wine quality data set
            self.cases = self.read_from_file("./data/winequality_white.txt", seperator=";", num_classes=7)
        elif self.data_source == "symmetry":
            self.cases = self.get_symmetry_cases()
        else:  # For cases to be generated by tflowtools, except symmetry
    ...
    def get_symmetry_cases(self):
        """ Get the symmetry cases and create a target vector """
        cases = []
    ...
    def read_from_mnist(self):
        """ Read mnist data, normalize into [0,1] and create target vector """
        cases = []
    ...
    def read_from_file(self, filename, seperator, num_classes, normalize=True):
        """ Read UC Irvine txt files, create target vector and normalize if needed"""
        ...
        with open(filename, "r") as file:
            ...
            for line in raw_data:
                ...
                # If a wine quality (red or white) data set, must modify target to start at 0 instead of 3
                if self.data_source == "wine" or self.data_source == "hackers-choice":
                    target[int(classification) - 3] = 1
                # If glass data set, it doesn't have class 4
                elif self.data_source == "glass":
                    ...
                    if index >= 4:  # Must decrease by one
                        ...
                        target[index] = 1
                else:  # Else yeast, which starts from 1
